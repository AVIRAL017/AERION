...
class HistoricalHazardItem(BaseModel):
    ...
    magnitude: Optional[float] = Field(default=None, description="Earthquake magnitude (Richter / moment magnitude)")
    depth_km: Optional[float] = Field(default=None, description="Hypocenter depth in kilometers")
    event_time: Optional[datetime] = Field(default=None, description="Precise UTC timestamp of seismic event")
